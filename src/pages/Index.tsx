...
// Features data moved to a constant to improve readability
const features = [
  {
    icon: Bot,
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-dark/90 via-dark/70 to-dark/90 pointer-events-none" />
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        ...
        >
          <div className="neon-border p-4 md:p-8 glass-card mb-8">
            ...
            >
              <h1 className={`${isMobile ? 'text-4xl' : 'text-6xl md:text-8xl'} font-bold gradient-text mb-6 animate-text-shimmer`}>
                wiredFRONT
              </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="glass-card p-6 md:p-8 group cursor-pointer relative overflow-hidden"
            >
