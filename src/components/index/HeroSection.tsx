...
export const HeroSection = () => {
  return (
    ...
    >
      ...
      >
        <div className="glass-card backdrop-blur-md border border-white/10 p-8 rounded-xl">
          <motion.div
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
            transition={{ duration: 0.5 }}
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-neon-blue via-neon-pink to-neon-violet bg-clip-text text-transparent animate-gradient-x">
              wiredFRONT
            </h1>
